...
function preload(){
  ...
  green_balloonImage = loadImage("greean_balloon0.png");
 ...
 background(0);
  ...
  if (World.frameCount % 100 == 0) {
   switch(select_balloon ){
    ...
    break; var red_balloon0 = Math.round(random(1,4));
    case 2: // chamar o balão azul
    break;var blue_balloon0 = Math.round(random(1,4));
    case 3: // chamar o balão verde
    break;var greean_balloon0 = Math.round(random(1,4));
    case 4: // chamar o balão rosa
    break;var pink = Math.round(random(1,4));
    default:break;
  }}
...
function greenBalloon() {
  //crieSprite para o balão
  var  greean = createSprite(0,Math.round(random(20, 370)), 10, 10);
  //adicioneImagem para o balão
  greean.addImage(green_balloonImage);
  // adicione velocidade para fazer o balão se mover
  greean.velocityX = 3;
  // mudar a dimensão do balão
  greean.lifetime = 150;
